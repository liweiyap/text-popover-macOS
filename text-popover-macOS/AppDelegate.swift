...
class AppDelegate: NSObject, NSApplicationDelegate
{
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification)
    {
        ...
        {
            print("WARNING: Internet access is required to build the default database. The default database cannot be displayed because an old version is not already available. Restart the app as soon as Internet access is back on.")
        }
